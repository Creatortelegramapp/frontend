          ...
          <div className="product-title-meta-data bg-white mb-3 py-3 dir-rtl">
            <div className="container">
              ...
              <div className="post-meta-data d-flex align-items-center justify-content-between">
                <a className="d-flex align-items-center" href="#"><img src={`${basePath}/assets/img/bg-img/9.jpg`} alt="" />Sarah<span>Follow</span></a><span className="d-flex align-items-center">
              ...
              <div className="rating-review-content">
                <ul className="ps-0">
                  <li className="single-user-review d-flex">
                    <div className="user-thumbnail mt-0"><img src={`${basePath}/assets/img/bg-img/7.jpg`} alt="" /></div>
                  ...
                  <li className="single-user-review d-flex">
                    <div className="user-thumbnail mt-0"><img src={`${basePath}/assets/img/bg-img/8.jpg`} alt="" /></div>
                    <div className="rating-comment">
                      <p className="comment mb-0">Very excellent product. Love it.</p><span className="name-date">Designing World 8 Dec 2024</span>
                    </div>
                  </li>
                  <li className="single-user-review d-flex">
                    <div className="user-thumbnail mt-0"><img src={`${basePath}/assets/img/bg-img/9.jpg`} alt="" /></div>
                    <div className="rating-comment">
